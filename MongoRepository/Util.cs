...
namespace MongoRepository
{
    ...
    internal static class Util
    {
        ...
        private static MongoDatabase GetDatabaseFromUrl(MongoUrl url)
        {
            ...
            //TODO: logger no database specified
            return null;
        }
        ...
        public static MongoCollection<T> GetCollectionFromDatabase<T>(MongoDatabase db)
            where T : IMongoEntity
        {
        ...
        private static string GetCollectionName<T>() where T : IMongoEntity
        {
